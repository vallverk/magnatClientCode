...
public class UIButtonEditor : UIButtonColorEditor
{
	...
	protected override void DrawProperties ()
	{
		...
		if (targets.Length == 1)
		{
			...
			NGUIEditorTools.DrawEvents("On Hover", button, button.onHover, false);
			NGUIEditorTools.DrawEvents("On Hover Over", button, button.onHoverOver, false);
		} else
		{
			UIButton button = target as UIButton;
			NGUIEditorTools.DrawEvents("On Click", button, button.onClick, false);
			...
			{
				UIButton b = t as UIButton;
				b.onHover = button.onHover;
				b.onHoverOver = button.onHoverOver;
			}
		}
	}
}
