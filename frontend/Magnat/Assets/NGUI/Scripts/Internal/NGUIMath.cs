...
static public class NGUIMath
{
	...
	static public Vector2 ConstrainRectFTop (Vector2 minRect, Vector2 maxRect, Vector2 minArea, Vector2 maxArea)
	{
		Vector2 offset = Vector2.zero;
		...
		{
			if (minRect.y < maxArea.y - contentY) offset.y += maxArea.y - contentY - minRect.y;
			if (maxRect.y > maxArea.y) offset.y -= maxRect.y - maxArea.y;
		}
